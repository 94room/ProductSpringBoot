...
public class ProductController {
	...
	@GetMapping("/products")
	public ResponseEntity<List<ProductTable>> getAllCustomers() {
		List<ProductTable> customers = new ArrayList<>();
		try {
	...
	public ResponseEntity<ProductTable> postProduct(@RequestBody ProductTable product) {
		try {
			ProductTable _product = repository.save(new ProductTable(product.getName(), product.getCategory(),product.getPrice(),
	...
	public ResponseEntity<ProductTable> updateCustomer(@PathVariable("id") long id, @RequestBody ProductTable product) {
		Optional<ProductTable> productData = repository.findById(id);
